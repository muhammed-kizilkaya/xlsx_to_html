...
def get_styles_from_cell(cell, merged_cell_map=None, default_cell_border="none"):
    ...
    if cell.font:
        ...
        if cell.font.color:
            h_styles['color'] = 'black'
        if cell.font.b:
            h_styles['font-weight'] = 'bold'
            h_styles['font-style'] = 'normal'
            h_styles['font-variant'] = 'normal'
            h_styles['text-decoration'] = 'none'
            h_styles['text-transform'] = 'none'
            h_styles['font-stretch'] = 'normal'
            h_styles['font-family'] = 'Arial'
            h_styles['font-color'] = 'red'
        if cell.font.i:
...
def yazdir(filepath, output=None, locale='en',
